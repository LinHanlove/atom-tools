import { computed, defineComponent, h, nextTick, onMounted, ref } from './chunk-X54IR6VG.js'
import { __publicField } from './chunk-JVWSFFO4.js'

// node_modules/.pnpm/@theojs+lumen@5.0.0/node_modules/@theojs/lumen/types/index.ts
import { default as default2 } from '/Users/linhan/Desktop/atom/atom-tools/node_modules/.pnpm/@theojs+lumen@5.0.0/node_modules/@theojs/lumen/components/DocBox.vue'
import { default as default3 } from '/Users/linhan/Desktop/atom/atom-tools/node_modules/.pnpm/@theojs+lumen@5.0.0/node_modules/@theojs/lumen/components/DocLinks.vue'
import { default as default4 } from '/Users/linhan/Desktop/atom/atom-tools/node_modules/.pnpm/@theojs+lumen@5.0.0/node_modules/@theojs/lumen/components/DocBoxCube.vue'
import { default as default5 } from '/Users/linhan/Desktop/atom/atom-tools/node_modules/.pnpm/@theojs+lumen@5.0.0/node_modules/@theojs/lumen/components/DocVideoLink.vue'
import { default as default6 } from '/Users/linhan/Desktop/atom/atom-tools/node_modules/.pnpm/@theojs+lumen@5.0.0/node_modules/@theojs/lumen/components/Announcement.vue'
import { default as default7 } from '/Users/linhan/Desktop/atom/atom-tools/node_modules/.pnpm/@theojs+lumen@5.0.0/node_modules/@theojs/lumen/components/DocAsideLogo.vue'
import { default as default8 } from '/Users/linhan/Desktop/atom/atom-tools/node_modules/.pnpm/@theojs+lumen@5.0.0/node_modules/@theojs/lumen/components/HomeFooter.vue'
import { default as default9 } from '/Users/linhan/Desktop/atom/atom-tools/node_modules/.pnpm/@theojs+lumen@5.0.0/node_modules/@theojs/lumen/components/HomeUnderline.vue'
import { default as default10 } from '/Users/linhan/Desktop/atom/atom-tools/node_modules/.pnpm/@theojs+lumen@5.0.0/node_modules/@theojs/lumen/components/DocTwikoo.vue'
import { default as default11 } from '/Users/linhan/Desktop/atom/atom-tools/node_modules/.pnpm/@theojs+lumen@5.0.0/node_modules/@theojs/lumen/components/ShareButton.vue'
...
function sortIcons(icons) {
  ...
  icons.forEach((icon) => {
    ...
    const providerStorage =
      storage3[provider] || (storage3[provider] = /* @__PURE__ */ Object.create(null))
    const localStorage =
...
function initBrowserStorage() {
  ...
  for (const key in browserStorageConfig) {
    iterateBrowserStorage(key, (item) => {
      ...
      storage3.lastModifiedCached = storage3.lastModifiedCached
        ? Math.min(storage3.lastModifiedCached, lastModified)
        : lastModified
      return true
    })
  }
  ...
  if (lastValue) {
    for (const key in browserStorageConfig) {
      iterateBrowserStorage(key, (item) => {
        const iconSet = item.data
        return (
          item.provider !== storage3.provider ||
          iconSet.prefix !== storage3.prefix ||
...
var loadIcons = (icons, callback) => {
  ...
  sortedIcons.pending.forEach((icon) => {
    ...
    const storage3 = getStorage(provider, prefix)
    const pendingQueue =
      storage3.pendingIcons || (storage3.pendingIcons = /* @__PURE__ */ new Set())
  ...
  render() {
    ...
    if (icon.classes) {
      newProps = {
        ...props,
        class:
          (typeof props['class'] === 'string' ? props['class'] + ' ' : '') + icon.classes.join(' ')
      }
    }
    return render(
      {
...
var validateIconName2 = (icon, allowSimpleName) => {
  ...
  return !!(
    (icon.provider === '' || icon.provider.match(matchIconName2)) &&
    ((allowSimpleName && icon.prefix === '') || icon.prefix.match(matchIconName2)) &&
    icon.name.match(matchIconName2)
  )
}
...
function internalGetIconData2(data, name, tree) {
  ...
  let currentProps = {}
  function parse(name2) {
    currentProps = mergeIconData2(icons[name2] || aliases[name2], currentProps)
  }
  parse(name)
  tree.forEach(parse)
...
function quicklyValidateIconSet2(obj) {
  ...
  for (const name in icons) {
    const icon = icons[name]
    if (
      !name.match(matchIconName2) ||
      typeof icon.body !== 'string' ||
      !checkOptionalProps2(icon, defaultExtendedIconProps2)
    ) {
      return null
    }
  }
...
function getStorage2(provider, prefix) {
  const providerStorage =
    dataStorage2[provider] || (dataStorage2[provider] = /* @__PURE__ */ Object.create(null))
  ...
  providers.forEach((provider2) => {
    const prefixes =
      typeof provider2 === 'string' && typeof prefix === 'string'
        ? [prefix]
        : Object.keys(dataStorage2[provider2] || {})
...
function sortIcons2(icons) {
  ...
  icons.forEach((icon) => {
    ...
    const providerStorage =
      storage3[provider] || (storage3[provider] = /* @__PURE__ */ Object.create(null))
    const localStorage =
      providerStorage[prefix] || (providerStorage[prefix] = getStorage2(provider, prefix))
    let list
    if (name in localStorage.icons) {
      list = result.loaded
    } else if (prefix === '' || localStorage.missing.has(name)) {
...
function initRedundancy2(cfg) {
  ...
  function query(payload, queryCallback, doneCallback) {
    const query2 = sendQuery2(config, payload, queryCallback, (data, error) => {
      cleanup()
      if (doneCallback) {
        doneCallback(data, error)
      }
...
var fallBackAPISources2 = ['https://api.simplesvg.com', 'https://api.unisvg.com']
var fallBackAPI2 = []
...
function storeInBrowserStorage2(storage3, data) {
  ...
  function store(key) {
    ...
    return setStoredItem2(func, browserCachePrefix2 + index.toString(), JSON.stringify(item))
  }
...
function iconToSVG2(icon, customisations) {
  ...
  ;[fullIcon, fullCustomisations].forEach((props) => {
    ...
    if (transformations.length) {
      body = wrapSVGContent2(body, '<g transform="' + transformations.join(' ') + '">', '</g>')
    }
  })
  const customisationsWidth = fullCustomisations.width
  const customisationsHeight = fullCustomisations.height
  ...
  if (customisationsWidth === null) {
    ...
    height =
      customisationsHeight === null
        ? calculateSize$1(width, boxHeight / boxWidth)
        : customisationsHeight === 'auto'
          ? boxHeight
          : customisationsHeight
  }
